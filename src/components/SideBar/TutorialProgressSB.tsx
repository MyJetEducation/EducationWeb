...
const TutorialProgressSB = (props: TutorialProgressSBProps) => {
  ...
  return (
    ...
    >
      ...
      <FlexContainer padding={'21px 32px 0'} marginBottom={'26px'}>
        <ProgressBar
      ...
      <FlexContainer flexDirection={'column'}>
        <TutorialUnitItem>
          ...
          >
            <FlexContainer
              ...
              zIndex={'1'}
            />
            <FlexContainer padding={'6px 0 0 0'} marginRight={'10px'}>
              <SvgIcon {...IconUnits} fillColor={'#C0C4C9'} />
            </FlexContainer>
            <FlexContainer flexDirection={'column'}>
              <PrimaryTextSpan>1.1 Text:</PrimaryTextSpan>
              <PrimaryTextSpan>
        ...
        <TutorialUnitItem>
          ...
          >
            ...
            <FlexContainer flexDirection={'column'}>
              <PrimaryTextSpan>1.2 Test:</PrimaryTextSpan>
              <PrimaryTextSpan>What is S.M.A.R.T.</PrimaryTextSpan>
            </FlexContainer>
          </FlexContainer>
        </TutorialUnitItem>
      </FlexContainer>
