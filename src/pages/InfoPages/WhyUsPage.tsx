...
const WhyUsPage = () => {
  ...
  return (
    <FlexContainer padding="58px 0" flex="1" flexDirection="column">
      ...
      >
        ...
        >
          ...
          <FlexContainer marginBottom="22px">
            ...
            <PrimaryTextSpan fontSize="16px" color="#000" lineHeight="24px">
              как мне правильно распоряжаться своим доходом, чтоб через год я мог начать инвестировать без займов, кредитов, долгов
            </PrimaryTextSpan>
          </FlexContainer>
      ...
      <FlexContainer width="100%" justifyContent="flex-start" marginBottom="52px">
        <FlexContainer width="740px">
          <FlexContainer marginRight="20px">
            ...
            <PrimaryTextSpan
              ...
              lineHeight="36px"
            >
              Мы разработали проект с оглядкой на то, что за три простых шага вам станут понятны и привычны действия богатых людей, которые учились управлять своими денежными средствами на протяжении многих лет.
            </PrimaryTextSpan>
      ...
      >
        ...
        >
          ...
          >
            <PrimaryTextSpan>
              Специалисты в области Money Management, Financial Psychology, Credits and Investments, Business Advisors помогли составить теоретические и практические задания для каждого, кто станет нашим клиентом. А также специалисты-партнеры проекта готовы делиться своим опытом, чтобы Вы становились финансово более уверенными в своих действиях каждый день.
            </PrimaryTextSpan>
          </FlexContainer>
